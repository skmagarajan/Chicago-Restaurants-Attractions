...
public class Attractions extends AppCompatActivity implements ListFragment.ListSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListArray = getResources().getStringArray(R.array.list_items);
        mLinkArray = getResources().getStringArray(R.array.url_items);
